...
document.addEventListener('DOMContentLoaded', function () {
    // Load data
    Promise.all([
        fetch('https://raw.githubusercontent.com/SergioPovoli/elezionivallelaghi2025/main/data/preferenze_2025.csv').then(res => res.text()),
        fetch('https://raw.githubusercontent.com/SergioPovoli/elezionivallelaghi2025/main/data/risultati_liste_vallelaghi_2025.csv').then(res => res.text())
